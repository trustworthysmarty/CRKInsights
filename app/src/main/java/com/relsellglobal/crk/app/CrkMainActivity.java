    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                new SmartSyncTableTask(null,1,CrkMainActivity.this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
            } else {
                new SmartSyncTableTask(null,1,CrkMainActivity.this).execute();
            }
