 ...
 */
public class CrkHomeListItemsCardAdapter extends RecyclerView.Adapter<CrkHomeListItemsCardAdapter.ViewHolder> {
    ...
    public CrkHomeListItemsCardAdapter(Context mContext, List<QuotesListItem> list, FragmentManager fm, int containerLayoutId) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        switch (viewType) {
            case CHILD:
                ...
                holder.quoteAuthor.setText("-- " + localObj.getAuthor());
